    ...
    _createClass(Signer, [
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    2,
                                    {
                                        address: (0, import_utils.bufferToHex)((0, import_secp256k1.getPublicKey)(key.privateKey, true)),
                                        privateKey: (0, import_utils.bufferToHex)(key.privateKey),
                                        publicKey: (0, import_utils.bufferToHex)((0, import_secp256k1.getPublicKey)(key.privateKey))
                                    }
                                ];
                        }
                    });
            ...
            value: function verify(msgHash, sig, publicKey) {
                return _asyncToGenerator(function() {
                    return __generator(this, function(_state) {
                        return [
                            2,
                            (0, import_secp256k1.verify)((0, import_utils.hexToBuffer)(sig), (0, import_utils.hexToBuffer)(msgHash), (0, import_utils.hexToBuffer)(publicKey))
                        ];
                    });
                })();
            }
        },
        {
            ...
            value: function sign(msgHash, keyPair) {
                var _this = this;
                return _asyncToGenerator(function() {
                    var msgHashBuffer, privateKeyBuffer, rsig, signature;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                msgHashBuffer = (0, import_utils.hexToBuffer)(msgHash);
                                privateKeyBuffer = (0, import_utils.hexToBuffer)(keyPair.privateKey);
                                return [
                                    4,
                                    (0, import_secp256k1.sign)(msgHashBuffer, privateKeyBuffer, {
                                        der: false,
                                        recovered: true
                                    })
                                ];
                            case 1:
                                ...
                                if (!_this.verify((0, import_utils.bufferToHex)(msgHashBuffer), (0, import_utils.bufferToHex)(signature), keyPair.publicKey)) {
                                    throw new Error(import_types.Errors.SigningErrors.UnableToVerify);
                                }
                                return [
                                    2,
                                    (0, import_utils.bufferToHex)(signature)
                                ];
                        }
                    });
                })();
